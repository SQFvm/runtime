...
void register_commmands(PVM vm)
{
	...
	create_cmd(vm, L"createUnit", 'b', cmd_createunit, 4, L"<GROUP> createUnit <ARRAY", L"", L"Create unit of a class that's defined in CfgVehicles. The Group parameter MUST be an existing group or the unit won't be created.");
