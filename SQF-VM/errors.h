...
#define ERR_CONFIGWITH L"CONFIG WITH VALUE OF TYPE "

#define ERR_NOT_EMPTY L"NOT EMPTY "
#define ERR_NOT_NULL L"NOT NULL "
...
#define ERR_SPECIAL_MERGEFROM ERR_ERR L"CANNOT MERGE VALUENODES"


#define WARN_SELECT_NIL_ARRSIZE L"INDEX OUT OF RANGE, RETURNING NIL AS EQUALS ARRAY LENGTH"
