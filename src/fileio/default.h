...
namespace sqf::fileio {
    ...
    private:
        struct path_element {
            ...
            std::unordered_map<std::string, std::shared_ptr<path_element>, next_hasher, next_comparator> next;
        ...
        std::optional<sqf::runtime::fileio::pathinfo>
        get_info_virtual(std::string_view view, sqf::runtime::fileio::pathinfo current) const;
        ...
        /// <returns>empty optional on filenotfound or the pathinfo to the actual file.</returns>
        std::optional<sqf::runtime::fileio::pathinfo>
        get_info_physical(std::string_view view, sqf::runtime::fileio::pathinfo current) const;
