...
namespace sqf
{
	...
	typedef std::shared_ptr<value>(*unarycb)(virtualmachine*, const value&);
	typedef std::shared_ptr<value>(*binarycb)(virtualmachine*, const value&, const value&);
	class cmd
	{
	private:
		type mltype;
	...
	public:
		...
		virtual std::shared_ptr<value> execute(virtualmachine*, const value& left, const value& right) const = 0;
	...
	public:
		...
		std::shared_ptr<value> execute(virtualmachine* vm, const value& left, const value& right) const override { return mfnc(vm); }
	};
	...
	public:
		...
		std::shared_ptr<value> execute(virtualmachine* vm, const value& left, const value& right) const override { return mfnc(vm, right); }
	};
	...
	public:
		...
		std::shared_ptr<value> execute(virtualmachine* vm, const value& left, const value& right) const override { return mfnc(vm, left, right); }
	};
