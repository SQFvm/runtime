...
namespace sqf::parser::preprocessor {
    ...
    private:
        ...
        public:
            ...
            void
            replace_skip(::sqf::runtime::runtime &runtime, preprocessorfileinfo &fileinfo, std::stringstream &sstream);
    ...
    public:
        ...
        virtual std::optional<std::string> preprocess(::sqf::runtime::runtime &runtime, std::string_view view,
