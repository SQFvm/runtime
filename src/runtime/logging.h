...
public:
    ...
    LogLocationInfo(std::string path, size_t line, size_t col) : path(path), line(line), col(col), offset(0),
                                                                 length(0) {}

    LogLocationInfo(std::string path, size_t line, size_t col, size_t offset, size_t length) : path(path), line(line),
...
namespace logmessage {
    ...
    namespace preprocessor {
        ...
        class UnknownPragma : public PreprocBase {
            static const loglevel level = loglevel::warning;
            static const size_t errorCode = 10014;
            std::string instruction;
        public:
        ...
        class RecursiveMacro : public PreprocBase {
            static const loglevel level = loglevel::warning;
            static const size_t errorCode = 10015;
        public:
            RecursiveMacro(LogLocationInfo loc) :
                    PreprocBase(level, errorCode, std::move(loc)) {}
    ...
    namespace runtime {
        ...
        public:
            ExpectedArrayTypeMissmatch(LogLocationInfo loc, size_t position, std::vector<::sqf::runtime::type> expected,
                                       ::sqf::runtime::type got) :
                    RuntimeBase(level, errorCode, std::move(loc)),
                    m_position(position),
                    m_expected(expected),
                    m_got(got) {}

            ExpectedArrayTypeMissmatch(LogLocationInfo loc, size_t position, ::sqf::runtime::type expected,
                                       ::sqf::runtime::type got) :
                    ExpectedArrayTypeMissmatch(loc, position, std::array<::sqf::runtime::type, 1>{expected}, got) {}

            template<size_t size>
            ExpectedArrayTypeMissmatch(LogLocationInfo loc, size_t position,
                                       std::array<::sqf::runtime::type, size> expected, ::sqf::runtime::type got) :
                    ExpectedArrayTypeMissmatch(loc, position,
                                               std::vector<::sqf::runtime::type>(expected.begin(), expected.end()),
                                               got) {}
        ...
        class ExpectedArrayTypeMissmatchWeak : public RuntimeBase {
            ...
            ::sqf::runtime::type m_got;
        public:
            ExpectedArrayTypeMissmatchWeak(LogLocationInfo loc, size_t position,
                                           std::vector<::sqf::runtime::type> expected, ::sqf::runtime::type got) :
                    RuntimeBase(level, errorCode, std::move(loc)),
                    m_position(position),
                    m_expected(expected),
                    m_got(got) {}

            ExpectedArrayTypeMissmatchWeak(LogLocationInfo loc, size_t position, ::sqf::runtime::type expected,
                                           ::sqf::runtime::type got) :
            ...
            ExpectedArrayTypeMissmatchWeak(LogLocationInfo loc, size_t position,
                                           std::array<::sqf::runtime::type, size> expected, ::sqf::runtime::type got) :
                    ExpectedArrayTypeMissmatchWeak(loc, position,
                                                   std::vector<::sqf::runtime::type>(expected.begin(), expected.end()),
                                                   got) {}
        ...
        class MagicVariableTypeMissmatch : public RuntimeBase {
            ...
            ::sqf::runtime::type m_got;
        public:
            MagicVariableTypeMissmatch(LogLocationInfo loc, std::string variable_name, ::sqf::runtime::type expected,
                                       ::sqf::runtime::type got) :
                    RuntimeBase(level, errorCode, std::move(loc)),
                    m_variable_name(variable_name),
                    m_expected(expected),
        ...
        class ExpectedSubArrayTypeMissmatch : public RuntimeBase {
            ...
            ::sqf::runtime::type m_got;
        public:
            ExpectedSubArrayTypeMissmatch(LogLocationInfo loc, std::vector<size_t> position,
                                          std::vector<::sqf::runtime::type> expected, ::sqf::runtime::type got) :
                    RuntimeBase(level, errorCode, std::move(loc)),
                    m_position(position),
                    m_expected(expected),
            ...
            template<size_t size>
            ExpectedSubArrayTypeMissmatch(LogLocationInfo loc, std::array<size_t, size> position,
                                          ::sqf::runtime::type expected, ::sqf::runtime::type got) :
                    ExpectedSubArrayTypeMissmatch(loc, position, std::array<::sqf::runtime::type, 1>{expected}, got) {}

            template<size_t size1, size_t size2>
            ExpectedSubArrayTypeMissmatch(LogLocationInfo loc, std::array<size_t, size1> position,
                                          std::array<::sqf::runtime::type, size2> expected, ::sqf::runtime::type got) :
                    ExpectedSubArrayTypeMissmatch(loc, std::vector<size_t>(position.begin(), position.end()),
                                                  std::vector<::sqf::runtime::type>(expected.begin(), expected.end()),
                                                  got) {}
        ...
        class ExpectedSubArrayTypeMissmatchWeak : public RuntimeBase {
            ...
            ::sqf::runtime::type m_got;
        public:
            ExpectedSubArrayTypeMissmatchWeak(LogLocationInfo loc, std::vector<size_t> position,
                                              std::vector<::sqf::runtime::type> expected, ::sqf::runtime::type got) :
                    RuntimeBase(level, errorCode, std::move(loc)),
                    m_position(position),
                    m_expected(expected),
            ...
            template<size_t size>
            ExpectedSubArrayTypeMissmatchWeak(LogLocationInfo loc, std::array<size_t, size> position,
                                              ::sqf::runtime::type expected, ::sqf::runtime::type got) :
                    ExpectedSubArrayTypeMissmatchWeak(loc, position, std::array<::sqf::runtime::type, 1>{expected},
                                                      got) {}

            template<size_t size1, size_t size2>
            ExpectedSubArrayTypeMissmatchWeak(LogLocationInfo loc, std::array<size_t, size1> position,
                                              std::array<::sqf::runtime::type, size2> expected,
                                              ::sqf::runtime::type got) :
                    ExpectedSubArrayTypeMissmatchWeak(loc, std::vector<size_t>(position.begin(), position.end()),
                                                      std::vector<::sqf::runtime::type>(expected.begin(),
                                                                                        expected.end()), got) {}
        ...
        public:
            ...
            ConfigEntryNotFound(LogLocationInfo loc, std::array<std::string, size> config_path, std::string config_name)
                    :
                    ConfigEntryNotFound(loc, std::vector<std::string>(config_path.begin(), config_path.end()),
                                        config_name) {}
        ...
        public:
            ...
            template<size_t size>
            ConfigEntryNotFoundWeak(LogLocationInfo loc, std::array<std::string, size> config_path,
                                    std::string config_name) :
                    ConfigEntryNotFoundWeak(loc, std::vector<std::string>(config_path.begin(), config_path.end()),
                                            config_name) {}
        ...
        public:
            UnknownInputTypeCombinationBinary(LogLocationInfo loc, ::sqf::runtime::type left_got, std::string op,
                                              ::sqf::runtime::type right_got) :
                    RuntimeBase(level, errorCode, std::move(loc)),
                    m_operator(op),
                    m_left_got(left_got),
        ...
        class ForStepVariableTypeMissmatch : public RuntimeBase {
            ...
            ::sqf::runtime::type m_got;
        public:
            ForStepVariableTypeMissmatch(LogLocationInfo loc, std::string variable_name, ::sqf::runtime::type expected,
                                         ::sqf::runtime::type got) :
                    RuntimeBase(level, errorCode, std::move(loc)),
                    m_variable_name(variable_name),
                    m_expected(expected),
    ...
    namespace fileio {
        ...
        public:
            ResolveVirtualFileMatched(LogLocationInfo loc, std::string_view phys, std::string_view virt,
                                      std::string_view match_phys) :
                    FileIoBase(level, errorCode, loc),
                    m_physical(phys),
                    m_virtual(virt),
        ...
        public:
            ResolveVirtualNavigateDown(LogLocationInfo loc, std::string_view phys, std::string_view virt,
        ...
        class ResolveVirtualNavigateDeadEnd : public FileIoBase {
            ...
            std::string_view m_matched;
        public:
            ResolveVirtualNavigateDeadEnd(LogLocationInfo loc, std::string_view phys, std::string_view virt,
                                          std::string_view matched) :
                    FileIoBase(level, errorCode, loc),
                    m_physical(phys),
                    m_virtual(virt),
        ...
        class ResolveVirtualNavigateNoNodesLeftForExploring : public FileIoBase {
            ...
            std::string_view m_virtual;
        public:
            ResolveVirtualNavigateNoNodesLeftForExploring(LogLocationInfo loc, std::string_view phys,
                                                          std::string_view virt) :
                    FileIoBase(level, errorCode, loc),
                    m_physical(phys),
                    m_virtual(virt) {}
        ...
        class ResolveVirtualTestFileExists : public FileIoBase {
            ...
            std::string_view m_matched;
        public:
            ResolveVirtualTestFileExists(LogLocationInfo loc, std::string_view phys, std::string_view virt,
                                         std::string_view matched) :
                    FileIoBase(level, errorCode, loc),
                    m_physical(phys),
                    m_virtual(virt),
        ...
        class ResolvePhysicalRequested : public FileIoBase {
            ...
            std::string_view m_matched;
        public:
            ResolvePhysicalRequested(LogLocationInfo loc, std::string_view phys, std::string_view virt,
                                     std::string_view matched) :
                    FileIoBase(level, errorCode, loc),
                    m_physical(phys),
                    m_virtual(virt),
        ...
        class ResolvePhysicalAdjustedPath : public FileIoBase {
            ...
            std::string_view m_matched;
        public:
            ResolvePhysicalAdjustedPath(LogLocationInfo loc, std::string_view phys, std::string_view virt,
                                        std::string_view matched) :
                    FileIoBase(level, errorCode, loc),
                    m_physical(phys),
                    m_virtual(virt),
        ...
        class ResolvePhysicalTestingAgainst : public FileIoBase {
            ...
            std::string_view m_matched;
        public:
            ResolvePhysicalTestingAgainst(LogLocationInfo loc, std::string_view phys, std::string_view virt,
                                          std::string_view matched) :
                    FileIoBase(level, errorCode, loc),
                    m_physical(phys),
                    m_virtual(virt),
        ...
        class ResolvePhysicalMatched : public FileIoBase {
            ...
            std::string_view m_matched;
        public:
            ResolvePhysicalMatched(LogLocationInfo loc, std::string_view phys, std::string_view virt,
                                   std::string_view matched) :
                    FileIoBase(level, errorCode, loc),
                    m_physical(phys),
                    m_virtual(virt),
        ...
        class ResolvePhysicalFailedToLookup : public FileIoBase {
            ...
            std::string_view m_matched;
        public:
            ResolvePhysicalFailedToLookup(LogLocationInfo loc, std::string_view phys, std::string_view virt,
                                          std::string_view matched) :
                    FileIoBase(level, errorCode, loc),
                    m_physical(phys),
                    m_virtual(virt),
        ...
        class ResolveVirtualFileNoNodesLeftFileNotFindable : public FileIoBase {
            static const loglevel level = loglevel::trace;
            static const size_t errorCode = 70021;
            std::string_view m_physical;
            std::string_view m_virtual;
        public:
            ResolveVirtualFileNoNodesLeftFileNotFindable(LogLocationInfo loc, std::string_view phys,
                                                         std::string_view virt) :
                    FileIoBase(level, errorCode, loc),
                    m_physical(phys),
                    m_virtual(virt) {}
        ...
        class FileLookupRequested : public FileIoBase {
            static const loglevel level = loglevel::trace;
            static const size_t errorCode = 70022;
            std::string_view m_request_physical;
            std::string_view m_request_virtual;
            std::string_view m_requested;
        public:
            FileLookupRequested(LogLocationInfo loc, std::string_view request_phys, std::string_view request_virt,
                                std::string_view requested) :
                    FileIoBase(level, errorCode, loc),
                    m_request_physical(request_phys),
                    m_request_virtual(request_virt),
                    m_requested(requested) {}

            [[nodiscard]] std::string formatMessage() const override;
        };

        class FileLookupCompletedWithVirtualFile : public FileIoBase {
            static const loglevel level = loglevel::verbose;
            static const size_t errorCode = 70023;
            std::string_view m_request_physical;
            std::string_view m_request_virtual;
            std::string_view m_resolved_physical;
            std::string_view m_resolved_virtual;
            std::string_view m_requested;
        public:
            FileLookupCompletedWithVirtualFile(LogLocationInfo loc, std::string_view request_phys,
                                               std::string_view request_virt, std::string_view requested,
                                               std::string_view resolved_phys, std::string_view resolved_virt) :
                    FileIoBase(level, errorCode, loc),
                    m_request_physical(request_phys),
                    m_request_virtual(request_virt),
                    m_requested(requested),
                    m_resolved_physical(resolved_phys),
                    m_resolved_virtual(resolved_virt) {}

            [[nodiscard]] std::string formatMessage() const override;
        };

        class FileLookupCompletedWithPhysicalFile : public FileIoBase {
            static const loglevel level = loglevel::verbose;
            static const size_t errorCode = 70024;
            std::string_view m_request_physical;
            std::string_view m_request_virtual;
            std::string_view m_resolved_physical;
            std::string_view m_resolved_virtual;
            std::string_view m_requested;
        public:
            FileLookupCompletedWithPhysicalFile(LogLocationInfo loc, std::string_view request_phys,
                                                std::string_view request_virt, std::string_view requested,
                                                std::string_view resolved_phys, std::string_view resolved_virt) :
                    FileIoBase(level, errorCode, loc),
                    m_request_physical(request_phys),
        ...
        class FileLookupCompletedWithNoFile : public FileIoBase {
            static const loglevel level = loglevel::verbose;
            static const size_t errorCode = 70024;
            std::string_view m_request_physical;
            std::string_view m_request_virtual;
            std::string_view m_requested;
        public:
            FileLookupCompletedWithNoFile(LogLocationInfo loc, std::string_view request_phys,
                                          std::string_view request_virt, std::string_view requested) :
                    FileIoBase(level, errorCode, loc),
                    m_request_physical(request_phys),
                    m_request_virtual(request_virt),
