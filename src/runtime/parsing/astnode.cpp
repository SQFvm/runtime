...
void sqf::parse::print_navigate_ast(std::basic_ostream<char, std::char_traits<char>>* outstreamptr, const astnode& node, const char *(*astkindname)(short), unsigned short level)
{
	if (level == 0)
	{
