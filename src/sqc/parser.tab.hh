...
#line 233 "parser.tab.hh" // lalr1.cc:377
  ...
  public:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        EQUALEQUALEQUAL = 312,
        EQUALEQUAL = 313,
        EXCLAMATIONMARKEQUALEQUAL = 314,
        EXCLAMATIONMARKEQUAL = 315,
        EXCLAMATIONMARK = 316,
        NUMBER = 317,
        IDENT = 318,
        STRING = 319,
        FORMAT_STRING_START = 320,
        FORMAT_STRING_CONTINUE = 321,
        FORMAT_STRING_FINAL = 322
      };
    };
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 766,     ///< Last index in yytable_.
