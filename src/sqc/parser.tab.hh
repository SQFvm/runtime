...
#line 243 "parser.tab.hh" // lalr1.cc:377
  ...
  public:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        EQUALEQUALEQUAL = 313,
        EQUALEQUAL = 314,
        EXCLAMATIONMARKEQUALEQUAL = 315,
        EXCLAMATIONMARKEQUAL = 316,
        EXCLAMATIONMARK = 317,
        NUMBER = 318,
        IDENT = 319,
        STRING = 320,
        FORMAT_STRING_START = 321,
        FORMAT_STRING_CONTINUE = 322,
        FORMAT_STRING_FINAL = 323
      };
    };
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 1066,     ///< Last index in yytable_.
