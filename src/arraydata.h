...
namespace sqf
{
	...
	public:
		...
		inline std::vector<std::shared_ptr<value>>::iterator begin(void) { return mvalue.begin(); }
		inline std::vector<std::shared_ptr<value>>::iterator end(void) { return mvalue.end(); }
