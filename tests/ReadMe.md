...
|   TEST   | `[METHOD, { 1 + 1 }, ARGUMENT]`               | The test to be executed. If provided as array, the first argument will be the test-case name,           |
|          | `[METHOD, ["testname", { 1 + 1 }], ARGUMENT]` | the second the actual test case. If just code, test-case name is the `str` version of the code.         |
