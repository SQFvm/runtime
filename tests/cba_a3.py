...
replace_in_file(os.path.join(addons_dir, 'arrays', 'test_findTypeName.sqf'), ' text ', ' ')
...
replace_in_file(os.path.join(addons_dir, 'common', 'test_macro_is_x.sqf'), 'parseText', '')
replace_in_file(os.path.join(addons_dir, 'common', 'test_weaponComponents.sqf'), ' text ', ' ')
replace_in_file(os.path.join(addons_dir, 'diagnostic', 'fnc_error.sqf'), ' text ', ' ')
replace_in_file(os.path.join(addons_dir, 'diagnostic', 'fnc_error.sqf'), 'QGVAR(Error) cutRsc [QGVAR(Error), "PLAIN"];', '')
replace_in_file(os.path.join(addons_dir, 'diagnostic', 'fnc_error.sqf'), 'lineBreak', '""')
replace_in_file(os.path.join(addons_dir, 'diagnostic', 'fnc_error.sqf'), 'parseText', '')
...
replace_in_file(os.path.join(addons_dir, 'main', 'script_macros_common.hpp'), 'text ', ' ')
